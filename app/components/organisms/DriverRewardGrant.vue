...
<template>
  <MoleculesSectionPanel
    ...
    note="Подарок по поводу — только плюс, водитель увидит его в разделе «Мои награды». Исправить ошибку в балансе — это ручная правка баллов выше. Товар и своя награда ждут в офисе по коду до конца срока, товар на это время уходит в резерв. Баллы зачисляются сразу и встанут в истории строкой «ручная правка»."
  >
