...
<template>
  <MoleculesSectionPanel
    title="Учётные записи в парке"
    note="Учётная запись — не личность. Увольнение и заведение заново дают вторую учётную запись тому же человеку, и поездки пишутся на обе."
  >
