 ...
 *
 * Тон — подсветка: `plain` спокойная, `green` «иди забирай», `gold` — подарок на главной.
 * Вид влияет только на отсвет подсвеченных тонов: `compact` — карточка в списке (отсвет
 * 7 % → 62 %), `full` — шапка экрана заказа, где отсвет глубже (8 % → 68 %). Это два вида
 * по решению, а не расхождение копий: сводить их в один нельзя. Золотой шапки нет —
 * у `gold` только `compact`.
 *
