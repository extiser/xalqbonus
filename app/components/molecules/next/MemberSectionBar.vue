...
<template>
  <header
    class="sticky top-(--xb-demo-offset) z-[5] flex items-center gap-3 border-b border-white/6 bg-[rgba(11,13,17,0.82)] px-4 pb-3.5 pt-[calc(14px+env(safe-area-inset-top))] backdrop-blur-[14px]"
  >
