 ...
 *
 * Ни номера заказа такси, ни второй стороны перевода здесь нет: это состав для сотрудника,
 * разбирающего спор у стойки, а не для водителя. Номер заказа за баллы приходит внутри
 * подписи причины готовым текстом.
 */
