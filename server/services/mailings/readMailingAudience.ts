 ...
 * с активной привязкой Telegram, фильтров нет. У демо-рассылки — только демо-водители
 * (issue #212).
 *
 ...
 */
export const readMailingAudience = async (isDemo: boolean): Promise<MailingAudienceResponse> =>
  countMailingAudience(isDemo);
