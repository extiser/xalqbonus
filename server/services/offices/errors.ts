 ...
 *
 * Отвечает ручка на это кодом двери `role_not_allowed`, а не «офиса нет»: офис может и быть,
 * но работать в нём этому человеку не положено (issue #122). Несуществующий офис отвечает
 * тем же — отличать «нет» от «не ваш» незачем.
 */
