 ...
 * прогонов свод не является и являться не может: окно живой синхронизации — одиннадцать
 * минут, прогон идёт раз в минуту, и один заказ попадает примерно в одиннадцать прогонов
 * подряд. Разница не в процентах, а на порядок.
 *
