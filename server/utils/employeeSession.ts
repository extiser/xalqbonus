 ...
 * а `password_changed_at` позже времени выпуска делает cookie недействительным — это и есть
 * «выйти на всех устройствах» (docs/decisions.md → «Сессия веба живёт в подписанном
 * cookie»).
 *
