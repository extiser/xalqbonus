 ...
 *
 * Ловится там, где ограничение базы — не последняя линия обороны, а рабочий механизм:
 * вторую активную привязку Telegram отбивают частичные уникальные индексы, и отбитая
 * попытка обязана стать исходом «в офис», а не пятисоткой у водителя в чате.
 */
